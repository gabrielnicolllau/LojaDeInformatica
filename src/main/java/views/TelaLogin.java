...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setMinimumSize(new java.awt.Dimension(576, 519));
        ...
        btnCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login_icon_off.png"))); // NOI18N
    ...
    private void txtSenhaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSenhaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (usuario.equals("admin") && senha.equals("admin")) {
                ...
                JOptionPane.showMessageDialog(null, "Bem-Vindo a nossa loja!");

                // Inicia a tela principal
                InterfacePrincipal novaInterfacePrincipal = new InterfacePrincipal();
