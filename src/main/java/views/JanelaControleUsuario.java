...
public class JanelaControleUsuario extends javax.swing.JFrame {

    List<Produto> listaDeProdutos = new ArrayList<>();
    private DefaultTableModel tableModel;

    public JanelaControleUsuario() {
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
        // criar objeto
        CadastrarUsuario novaJanelaInserir = new CadastrarUsuario(this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaControleUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaControleUsuario().setVisible(true);
            }
        });
    }
